 ...
 * under the License.
 */
namespace Geekmancn\Aliyun\Gateway\Util;

use Geekmancn\Aliyun\Gateway\Constant\Constants;
...
class SignUtil
{
    ...
    /**
     * 构建待签名Http头
     * @param array $headers                  请求中所有的Http头
     * @param array $signHeaderPrefixList     自定义参与签名Header前缀
     * @return string
     */
